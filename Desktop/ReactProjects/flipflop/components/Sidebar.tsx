...
const Sidebar = () => {
  ...
  return (
    <div>
      ...
      {showSidebar && (
        <div className='xl:w-400 w-20 flex flex-col justify-start mb-10 border-r-2 border-gray-100 sl:border-0 p-3'>
          <div className='xl:border-b-2 border-gray-200 sl:pb-4'>
            <Link href='/'>
              <div className={normalLink}>
                <p className='text-2xl'><AiFillHome /></p>
                <span className='text-s=xl hidden xl:block'>
                  For you
                </span>
              </div>
            </Link>
